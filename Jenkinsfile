      ...
      steps {
        script {
          ...
          if (env.BRANCH_NAME == 'release/1.0.0') {
            ...
            sh "sshpass -p r00tme ssh -o StrictHostKeyChecking=no root@192.168.30.53 \"kubectl delete -f /srv/sky/nmap-driver/nmap-driver.yaml ; kubectl apply -f /srv/sky/nmap-driver/nmap-driver.yaml\""
          }
          if (env.BRANCH_NAME == 'test') {
            ...
            sh "sshpass -p r00tme ssh -o StrictHostKeyChecking=no root@192.168.30.52 \"kubectl delete -f /srv/sky/nmap-driver/nmap-driver.yaml ; kubectl apply -f /srv/sky/nmap-driver/nmap-driver.yaml\""
          }
          if (env.BRANCH_NAME == 'develop') {
            ...
            sh "sshpass -p r00tme ssh -o StrictHostKeyChecking=no root@192.168.30.51 \"kubectl delete -f /srv/sky/nmap-driver/nmap-driver.yaml ; kubectl apply -f /srv/sky/nmap-driver/nmap-driver.yaml\""
          }
        }
      }
    }
